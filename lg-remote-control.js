...
class LgRemoteControl extends LitElement {
    ...
    render() {
        ...
        const outputHasSoundbar = this.config.support_soundbar === "enable";
...
<!-- ################################# SOUND ################################# -->
                  <div class="grid-container-sound">
                    ...
                    ${this._show_text ? html`
                        <button class="btn_soundoutput ripple" @click=${() => this._show_text = false}>SOUND</button>
                          ...
                          ${outputHasSoundbar ? html`
                            <button class="${stateObj.attributes.sound_output === "external_speaker" ? 'btn_sound_on opt bnt_sound_text_width' : 'btn_sound_off opt bnt_sound_text_width ripple overlay'}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${() => this._select_sound_output("external_speaker")}>Optical</button>
                            <button class="${stateObj.attributes.sound_output === "soundbar" ? 'btn_sound_on hdmi bnt_sound_text_width' : 'btn_sound_off hdmi bnt_sound_text_width ripple overlay'}"style="margin-left: calc(var(--remotewidth) / 10);" @click=${() => this._select_sound_output("soundbar")}>HDMI</button>
                          ` : html`
                  ...
                  ` : html`
                      <button class="sound_icon_text  ripple" @click=${() => this._show_text = true}><ha-icon style="height: calc(var(--remotewidth) / 6); width: calc(var(--remotewidth) / 6);" icon="mdi:speaker"></button>
                        ...
                        ${outputHasSoundbar ? html`
                            <button class="${stateObj.attributes.sound_output === "external_speaker" ? 'btn_sound_on opt bnt_sound_icon_width' : 'btn_sound_off opt bnt_sound_icon_width ripple overlay'}" style="margin-right: calc(var(--remotewidth) / 7.5);" @click=${() => this._select_sound_output("external_speaker")}>${LgRemoteControl.optic}</button>
                            <button class="${stateObj.attributes.sound_output === "soundbar" ? 'btn_sound_on hdmi bnt_sound_icon_width' : 'btn_sound_off hdmi bnt_sound_icon_width ripple overlay'}"style="margin-left: calc(var(--remotewidth) / 7.5);" @click=${() => this._select_sound_output("soundbar")}>${LgRemoteControl.arc}</button>
                        ` : html`
